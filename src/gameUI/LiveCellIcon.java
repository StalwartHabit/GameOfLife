...
/** Creates the icon to represent a living cell
 * @author chris
 *
 */
public class LiveCellIcon implements Icon {
	public static final int WIDTH_SPACING_RATIO = 15;
	public static final int HEIGHT_SPACING_RATIO = 15;
	public static final Color BACKGROUND_COLOUR = Color.WHITE;
	public static final Color CELL_COLOUR = Color.BLACK;
	
	private int width;
	private int height;
	
	public LiveCellIcon(int width, int height) {
		this.height = height;
		this.width = width;
	}
